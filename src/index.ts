...
export default async () => {
  ...
  logger.log(
    "discordplus: UI-critical initialization complete — deferring plugin & network work",
  );
  ...
  const runDeferred = async () => {
    ...
    // Start discordplus (Bunny) plugins now without forcing repository updates.
  ...
  logger.log("discordplus is ready.");
};
